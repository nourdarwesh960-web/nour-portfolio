  ...
  en: {
    ...
    services: {
      ...
      items: [
        ...
        },
        {
          ...
          desc: 'Working with essential Microsoft Office tools for documents, spreadsheets, presentations, email, and database management.',
          list: ['Microsoft Word', 'Microsoft Excel', 'Microsoft PowerPoint', 'Microsoft Outlook', 'Microsoft Access'],
        },
      ],
    },
    work: {
      ...
      items: [
        ...
        {
          title: 'Hasala',
          summary: 'A modern web application built with React and JavaScript, focused on a clean, responsive, and easy-to-use experience.'
        },
  ...
  ar: {
    ...
    work: {
      ...
      items: [
        ...
        {
          title: 'Hasala',
          summary: 'Hasala web application built with React and JavaScript, focused on a clean, responsive, and easy-to-use experience.'
        },
      ],
    },
    contact: {
...
function Projects({ t }) {
  ...
  const links = [
    ...
    STORE_URL,
    LINKGUARD_URL,
    'https://hasala.nourdarwesh960.workers.dev/',
  ];
...
function SVGHasala() {
  return (
    ...
    >
      <defs>
        <linearGradient id="hasalaBg" x1="0" y1="0" x2="1" y2="1">
          <stop offset="0%" stopColor="#111827" />
          <stop offset="100%" stopColor="#050505" />
        </linearGradient>
        <linearGradient id="hasalaAccent" x1="0" y1="0" x2="1" y2="0">
      ...
      <rect
        ...
        fill="#151518"
      />
      <circle cx="30" cy="30" r="3" fill="#555" />
      <circle cx="40" cy="30" r="3" fill="#555" />
      <circle cx="50" cy="30" r="3" fill="#555" />
      <rect
        x="72"
        y="25"
        width="145"
      ...
      <rect
        ...
        height="7"
        rx="3"
        fill="url(#hasalaAccent)"
      />
      <rect x="38" y="82" width="25" height="5" rx="2" fill="#444" />
      <rect x="38" y="96" width="30" height="5" rx="2" fill="#333" />
      <rect x="38" y="110" width="22" height="5" rx="2" fill="#333" />
      <rect x="38" y="124" width="28" height="5" rx="2" fill="#333" />
      <rect x="38" y="138" width="20" height="5" rx="2" fill="#333" />
      <rect
        x="96"
        y="54"
        width="65"
      ...
      <rect
        ...
        stroke="#2c2c32"
      />
      <rect x="104" y="93" width="20" height="5" rx="2" fill="#555" />
      <rect x="104" y="103" width="32" height="7" rx="3" fill="#eee" />
      <rect x="168" y="93" width="20" height="5" rx="2" fill="#555" />
      <rect x="168" y="103" width="30" height="7" rx="3" fill="#eee" />
      <rect x="232" y="93" width="20" height="5" rx="2" fill="#555" />
      <rect x="232" y="103" width="27" height="7" rx="3" fill="#eee" />
      <rect
        x="96"
        y="127"
        width="185"
      ...
      />
      <path
        d="M105 151 L125 143 L143 147 L162 136 L181 141 L201 131 L220 138 L240 128 L260 133 L272 124"
        fill="none"
        stroke="url(#hasalaAccent)"
        strokeWidth="2"
      />
      <line
        x1="105"
...
export default function App() {
  ...
  return (
    <div className="app" data-theme={theme} dir={t.dir}>
      ...
      <AnimatePresence>
        {!introDone && (
          <Intro
            ...
            onEnter={() => {
            setIntroDone(true);
            setShowArabicHint(true);
            window.setTimeout(() => setShowArabicHint(false), 3000);
          }}
          />
        )}
      </AnimatePresence>
      ...
      {showArabicHint && (
        <div className={`arabic-hint ${lang === 'ar' ? 'arabic-hint-ar' : ''}`}>
          <div className="arabic-hint-icon">{'ع'}</div>
          <div className="arabic-hint-content">
            <strong>
              {lang === 'ar'
                ? 'اقرأ البورتفوليو بالعربي'
                : 'Prefer Arabic?'}
            </strong>
            <span>
              {lang === 'ar'
                ? 'تقدر تقرأ البورتفوليو كامل بالعربي من هنا.'
                : 'You can read the portfolio in Arabic from here.'}
            </span>
          </div>
          <button
            type="button"
            className="arabic-hint-action"
            onClick={() => {
              toggleLang();
          ...
          <button
            type="button"
            className="arabic-hint-close"
            aria-label="Close"
            onClick={() => setShowArabicHint(false)}
          >
            ?
          </button>
        </div>
